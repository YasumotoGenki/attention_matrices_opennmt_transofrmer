...
class TranslationBuilder(object):
    ...
    def from_batch(self, translation_batch):
        ...
        preds, pred_score, attn, src_tgt_attn, align, gold_score, indices = list(zip(
            *sorted(zip(translation_batch["predictions"],
                        translation_batch["scores"],
                        translation_batch["attention"],
                        translation_batch["src_tgt_attn"],
        ...
        for b in range(batch_size):
            ...
            translation = Translation(
                src[:, b] if src is not None else None,
                src_raw, pred_sents, attn[b], src_tgt_attn[b], pred_score[b],
...
class Translation(object):
    ...
    __slots__ = ["src", "src_raw", "pred_sents", "attns", "src_tgt_attn", "pred_scores",
                 "gold_sent", "gold_score", "word_aligns"]

    def __init__(self, src, src_raw, pred_sents,
                 attn, src_tgt_attn, pred_scores, tgt_sent, gold_score, word_aligns):
        self.src = src
        self.src_raw = src_raw
        self.pred_sents = pred_sents
        self.attns = attn
        self.src_tgt_attn = src_tgt_attn
